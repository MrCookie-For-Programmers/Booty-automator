...
def type_the_string(current_string):
    ...
    debug_print(f"Calling pyautogui.write('{current_string}', interval={write_interval}).")
    ...
    try:
        with open(file_path, 'r', encoding='utf-8') as f: # Using utf-8 for broader compatibility
            ...
            for line_num, line in enumerate(f, 1):
                ...
                pyautogui.write(content_to_type, interval=write_interval)
                pyautogui.press('enter')
...
if __name__ == "__main__":
    ...
    print("\n[INFO] Script has quit. Goodbye, Philipp!")
