...
if __name__ == "__main__":
    ...
    try:
        ...
        for current_string in generator:
            ...
            print(f"[DEBUG] Processing string '{current_string}' - single action.") # Updated print for debug
            ...
            try:
                ...
                print("[DEBUG] FailSafeException caught. STOP_SCRIPT set to True. Breaking loop.") # Updated debug print
            ...
            if STOP_SCRIPT: # Check again in case fail-safe or error broke before sleep
                print("[DEBUG] STOP_SCRIPT is True after action. Breaking main loop.")
                break
