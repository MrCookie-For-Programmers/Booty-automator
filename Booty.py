...
def show_credits_page():
    ...
    print("\nThis script is licensed under the GPLv3.0 license")
    print("Feel free to inspect, modify, and distribute as long as the script remains free (but please credit the original authors!).")
    handle_enter_to_continue()
